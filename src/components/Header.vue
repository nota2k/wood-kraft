  ...
  <header class="header" :class="{ 'header--hidden': !isVisible, 'header--open': isNavOpen }">
    <div class="header__container">
      ...
      <div class="nav-wrapper">
        ...
        <button class="nav-icon" :class="{ 'nav-icon--open': isNavOpen }" @click="toggleNav"
          aria-label="Toggle navigation">
          <svg class="nav-icon__svg" :class="{ 'nav-icon__svg--open': isNavOpen }" width="76" height="76"
            viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path ref="path1Ref" :d="closedPaths[0]" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
            <path ref="path2Ref" :d="closedPaths[1]" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
...
.header {
  ...
  &__nav {
    ...
    @media (max-width: 768px) {
      ...
      // On mobile, les liens sont toujours "rendus" mais cachés par opacity/visibility
      // Le bouton nav-icon gère l'ouverture/fermeture
    }
  }
